...
def read_dofmap_legacy(comm: MPI.Intracomm, filename: pathlib.Path,
...
def send_cells_and_receive_dofmap_index(filename: pathlib.Path, comm: MPI.Intracomm,
    ...
    input_dofs = read_dofmap_legacy(comm, filename, dofmap_path, xdofmap_path,
...
def read_function_from_legacy_h5(comm: MPI.Intracomm, filename: pathlib.Path,
    ...
    local_values = send_dofs_and_recv_values(dofmap_indices, dof_owner, comm, local_array, starting_pos)
