...
def create_reference_data(
    ...
    with dolfin.XDMFFile(mesh.mpi_comm(), str(xdmf_file)) as xdmf:
        ...
        xdmf.write_checkpoint(
            u, function_name, 0, dolfin.XDMFFile.Encoding.HDF5, append=True
        )
...
if __name__ == "__main__":
    ...
    verify_hdf5(
        u_ref, h5_filename, inputs.name, inputs.f_name, inputs.family, inputs.degree
    )

    verify_xdmf(u_ref, xdmf_filename, inputs.f_name, inputs.family, inputs.degree)
